...
RUN wget --no-verbose http://download.boulder.ibm.com/ibmdl/pub/software/server/mldl/mldl-repo-local_1-3ibm5_ppc64el.deb && dpkg --install mldl*.deb && rm -f mldl*.deb
